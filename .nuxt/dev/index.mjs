...
import { renderSSRHead } from 'file:///home/st/Nuxt-Project/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///home/st/Nuxt-Project/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///home/st/Nuxt-Project/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///home/st/Nuxt-Project/node_modules/unenv/runtime/fetch/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/home/st/Nuxt-Project/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/st/Nuxt-Project","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/st/Nuxt-Project/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/st/Nuxt-Project/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/st/Nuxt-Project/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/st/Nuxt-Project/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _FWRQAIIaG6 = (function(nitro) {
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"}],"link":[{"rel":"stylesheet","href":"https://fonts.googleapis.com/icon?family=Material+Icons"}],"style":[],"script":[{"src":"https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.0/js/bootstrap.bundle.min.js"}],"noscript":[],"title":"Nuxt-js Project"};
...
const getClientManifest = () => import('file:///home/st/Nuxt-Project/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///home/st/Nuxt-Project/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
